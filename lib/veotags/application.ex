defmodule Veotags.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: Veotags.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    VeotagsWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
